...
CHAT = [
    "Hello, Assistant.",
    "Hello human. How may I help you today?",
]

# Define the initial instruction for the conversation.
INSTRUCTION = "A chat between a human and an ai assistant. The assistant is polite; offering detailed, and succinct answers to the human's questions. output in Chinese"
